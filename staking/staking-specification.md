...
|--|--|--|
|`addExchangeAddress`|Adds an exchange address that will pay protocol fees.|[MixinExchangeManager](https://github.com/0xProject/0x-monorepo/blob/3.0/contracts/staking/contracts/src/fees/MixinExchangeManager.sol#L43)|
|`aggregatedStatsByEpoch`|Returns aggregated stats across all pools that generated fees with sufficient stake to earn rewards.|[MixinStorage](https://github.com/0xProject/0x-monorepo/blob/3.0/contracts/staking/contracts/src/immutable/MixinStorage.sol#L112)|
...
<p align="center"><img src="./assets/StakeManagementExample.png" width="640" /></p>
